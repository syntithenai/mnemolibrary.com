               ...
               <form style={{fontSize:'1.8em'}}>
                    <div style={{clear:'both', width:'100%'}}>
                        ...
                        <div style={{width:'80%'}}>
                            ...
                            <div className='form-group' >
                                <label htmlFor="outputvolume" >Speaker </label>
                   ...
                   <div className='form-group' >
                     ...
                     <div className='form-group' >
                        <hr style={{width:'100%'}}/ >
                        <span  onClick={this.resetConfig}><button className='btn btn-danger' style={{float:'left',fontSize:'1em'}}> {resetIcon} Reset Configuration</button></span>
                        {<span  onClick={this.deactivate}><button className='btn btn-danger' style={{float:'right',fontSize:'1em'}}> Deactivate Microphone</button></span>} 
