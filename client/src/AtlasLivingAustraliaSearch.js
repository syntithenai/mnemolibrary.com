...
export default class AtlasLivingAustraliaSearch extends Component {   
	...
	addToReview(result,resultKey,user) {
		...
		that.props.fetch('/api/importquestion', {
		  ...
		  body: JSON.stringify(Object.assign({user:user,tags:tags,quiz:quiz,access:'public',interrogative:interrogative,question:that.getScientificName(result),guid:that.getScientificName(result),difficulty:3,autoshow_image:"YES",image:that.getBase64Image(resultKey),image2:mapImage,answer:that.getName(result)+' '+result.description,headlineFacts: headlineFacts,link:link,importtype:'species',importId:'userimport'},{}))
		}).then(function() {
