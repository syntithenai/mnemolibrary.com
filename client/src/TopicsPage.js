    ...
    render() {
        return (
            <div>
                ...
                <span style={{ paddingLeft:'1em',width: '60%',float:'right'}}><RecentSingleComment newCommentReply={this.props.newCommentReply} user={this.props.user}  newCommentReply={this.props.newCommentReply} fetch={this.props.fetch} /></span>
