...
export default class QuizCollection extends Component {
    ...
    discoverOneByDifficulty(difficulty) {
      ...
      return that.props.fetch(url,{ method: "POST",headers: {
            ...
            if (collection.topics) {
              ...
              return <div  >
                    <div  ref={(section) => { this.scrollTo.topofpage = section; }} ></div>
                      ...
                      <QuizList quizzes={collatedTopics} setQuiz={this.props.setQuizFromTopic} questionsMissingMnemonics={this.props.questionsMissingMnemonics}   setQuizFromMissingMnemonic={this.props.setQuizFromMissingMnemonic} isLoggedIn={this.props.isLoggedIn} collection={collection}  fetch={this.props.fetch}  ></QuizList>
                    </div>
            }
        } else {
