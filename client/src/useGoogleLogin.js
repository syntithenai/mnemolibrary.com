...
export default function useGoogleLogin({scopes=null, usePrompt=false, loginButtonId=null}) {
    ...
    //console.log('gl CLIENTID ',clientId)
    ...
    function logout() {
        //console.log("logout")
        //localStorage.setItem('google_login_user',null)
      setUser(null)
      setAccessToken(null)
      localStorage.setItem('google_login_user','')
    ...
    return {user,token: accessToken, login, logout, refresh, ready}
}
