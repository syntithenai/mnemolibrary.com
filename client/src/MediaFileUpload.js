...
class MediaFileUpload extends React.Component {
  ...
  constructor(props) {
    ...
    initWebmWorker() {
        ...
        let webmWorker = new Worker("/worker/ffmpeg-worker-webm.js");
    ...
    initMp4Worker() {
        ...
        let mp4Worker = new Worker("/worker/ffmpeg-worker-mp4.js");
    ...
    initOtherWorker() {
        ...
        let otherWorker = new Worker("/worker/ffmpeg-worker-all-codecs.js");
   ...
   //             console.log(message.data)
	...
	//uploadFile(file) {
        ...
        //return new Promise(function(resolve,reject) {
			...
			//fileName = that.props.scrubFilename(fileName)
			//let key = that.props.s3path+"/"+fileName
			...
			//}, function(err, data) {
				...
				//}
				//console.log('Finished uplostorytellerwizardad')
				//console.log(data);
            ...
            that.myUploader = new S3Upload({
                ...
                onFinishS3Put: function(result) {
                    ...
                    if (that.state.uploadField) {
                        ...
                        uploaded[that.state.uploadField]='https://'+"s3."+process.env.REACT_APP_REGION+".amazonaws.com"+"/"+process.env.REACT_APP_S3_BUCKET+"/"+result.filename+'?rand='+String(new Date().getTime());
                        that.setState({uploaded:uploaded});                    
                        that.setState({active:true});                    
                    }
                    resolve();
